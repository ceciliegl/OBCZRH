...
int main(int argc, char const *argv[])
{
  ...
  string folder = std::string(getenv("HOME")) + std::string("/Documents/OBCZRH/Data/") + std::string(project) + std::string("/Run") + std::string(run_number) + std::string("/");
  ...
  vector<double> Sz0Szj(2*params.Nsites, 0.0);
